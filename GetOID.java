...
/**
 * ClassName: GetOID
 * Description: get the information of localhost
 * @author Richard
 * @version 1.0 V
...
public class GetOID {
    ...
    public static void main(String[] args) throws Exception{  
        ...
        try{  
            ...
            //定义本机的地址   10.72.35.183
            Address localAdd = GenericAddress.parse("udp:10.72.35.183/161");
            //设定远程主机的地址 
            ...
            if(response != null){  
                 ...
                 * request.size()=2
                   response.size()=2
                    1.3.6.1.2.1.1.1.0 = Hardware: Intel64 Family 6 Model 58 Stepping 9 AT/AT COMPATIBLE - Software: Windows Version 6.3 (Build 15063 Multiprocessor Free)
